...
The first approach is to categorise all variables in the form of a market
...
variables are much larger than the 5% significance level, there is not enough evidence to reject the null hypothesis, meaning that the means of
